...
type Row = { id: string; role_title: string | null; area: string | null; active: boolean; people: { full_name: string } | null }
              ...
              <tbody className="divide-y divide-gray-100">
                {rows.map(s => (
                  <tr key={s.id} className="hover:bg-gray-50">
                    ...
                    <td className="hidden md:table-cell px-4 py-3 text-gray-500">{s.role_title ?? '—'}</td>
