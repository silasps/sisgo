...
export function FloorCard({ href, name, destination, genderConstraint, roomCount, occupiedBeds, totalBeds, hold, actions }: Props) {
  ...
  return (
    <div className="relative">
      {/* Ações fora do <Link> de propósito — ver comentário em BlockCard.tsx */}
