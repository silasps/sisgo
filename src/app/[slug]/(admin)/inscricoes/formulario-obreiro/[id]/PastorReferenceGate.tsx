...
import { pularReferenciaPastor } from './actions'
...
export function PastorReferenceGate({ staffApplicationId, organizationId, slug, status, skipReason, skippedByName, skippedAt, readOnly }: Props) {
      ...
      {open ? (
        <div className="space-y-2">
          <textarea
            ...
            placeholder="Justificativa obrigatória (ex.: candidato sem igreja vinculada, pastor inalcançável...)"
            rows={3}
          ...
          <div className="flex gap-2">
            <button
              ...
              onClick={() => startTransition(async () => {
                await pularReferenciaPastor({ staffApplicationId, organizationId, slug, reason })
